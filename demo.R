...
dataset <- dataset
################################################
ltraindata<-dataset#鐎涙ê鍋嶉弽鍥╊劮閸氬海娈戠拋顓犵矊閺佺増宓?
################################################
...
prenomaltraindata<-dataset#娣囨繂鐡ㄨぐ鎺嶇閸栨牕澧犻惃鍕殶閹??
######################################################
x=dataset
...
dataset = df2
#########################
ltestdata<-dataset#娣囨繂鐡ㄧ悰銊ヮ槻閸氬牏澹掑浣告倵閻ㄥ嫯顔勭紒鍐╂殶閹??
#########################
